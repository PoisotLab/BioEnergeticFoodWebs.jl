...
The function can be called with the default parameters:
	- exponential_BA_r()
Parameters can also be specified:
	- exponential_BA_r(passed_temp_parameters = (norm_constant = exp(-15.68)*86400, activation_energy = -0.72, T0 = 298.15, β = -0.25))
"""
function exponential_BA_r(default_temp_parameters = (norm_constant = exp(-15.68)*86400, activation_energy = -0.84, T0 = 298.15, β = -0.25); passed_temp_parameters...)
    k = 8.617e-5
	if length(passed_temp_parameters) != 0
	  tmpargs = passed_temp_parameters[:passed_temp_parameters]
	  temperature_param = merge(default_temp_parameters, tmpargs)
...
| Parameter                      | Meaning                                         | Default values     | Reference                             |
|:-------------------------------|:------------------------------------------------|:-------------------|:--------------------------------------|
| norm_constant_producer         | scaling coefficient for producers               | exp(-16.54)*86400  | Ehnes et al. 2011, Binzer et al. 2012 |
| norm_constant_invertebrate     | scaling coefficient for invertebrates           | exp(-16.54)*86400  | Ehnes et al. 2011, Binzer et al. 2012 |
| norm_constant_vertebrate       | scaling coefficient for vertebrates             | exp(-16.54)*86400  | Ehnes et al. 2011, Binzer et al. 2012 |
...
| T0_producer                    | normalization temperature (K) for producers     | 298.15             | Binzer et al. 2012					|
| T0_invertebrate                | normalization temperature (K) for invertebrates | 298.15             | Binzer et al. 2012					|
| T0_vertebrate                  | normalization temperature (K) for vertebrates   | 298.15             | Binzer et al. 2012					|
...
The function can be called with the default parameters:
	- exponential_BA_x()
Parameters can also be specified:
	- exponential_BA_x(passed_temp_parameters = (norm_constant_producer = exp(-16.54)*86400, norm_constant_invertebrate = exp(-16.54)*86400, norm_constant_vertebrate = exp(-16.54)*86400,
	                                   activation_energy_producer = -0.69, activation_energy_invertebrate = -0.69, activation_energy_vertebrate = -0.69,
	                                   T0_producer = 298.15, T0_invertebrate = 298.15, T0_vertebrate = 298.15,
	                                   β_producer = -0.31, β_invertebrate = -0.31, β_vertebrate = -0.31))
"""
function exponential_BA_x(default_temp_parameters = (norm_constant_producer = exp(-16.54)*86400, norm_constant_invertebrate = exp(-16.54)*86400, norm_constant_vertebrate = exp(-16.54)*86400,
                                   activation_energy_producer = -0.69, activation_energy_invertebrate = -0.69, activation_energy_vertebrate = -0.69,
                                   T0_producer = 298.15, T0_invertebrate = 298.15, T0_vertebrate = 298.15,
...
| Parameter                      | Meaning                                         | Default values   | Reference                             |
|:-------------------------------|:------------------------------------------------|:-----------------|:--------------------------------------|
| norm_constant_invertebrate     | scaling coefficient for invertebrate            | exp(-13.1)*86400 | Rall et al. 2012, Binzer et al. 2015  |
| norm_constant_vertebrate       | scaling coefficient for vertebrate              | exp(-13.1)*86400 | Rall et al. 2012, Binzer et al. 2015  |
...
| T0_invertebrate                | normalization temperature (K) for invertebrates | 298.15           | Rall et al. 2012, Binzer et al. 2015  |
| T0_vertebrate                  | normalization temperature (K) for vertebrates   | 298.15           | Rall et al. 2012, Binzer et al. 2015  |
...
Parameters can also be specified:
	- exponential_BA_attackr(passed_temp_parameters = (norm_constant_vertebrate = exp(-13.1)*86400, norm_constant_invertebrate = exp(-13.1)*86400,
	                             activation_energy_vertebrate = -0.38, activation_energy_invertebrate = -0.38,
	                             T0_vertebrate = 298.15, T0_invertebrate = 298.15,
	                             β_producer = 0.25, β_vertebrate = -0.8, β_invertebrate = 0.8))
"""
function exponential_BA_attackr(default_temp_parameters = (norm_constant_vertebrate = exp(-13.1)*86400, norm_constant_invertebrate = exp(-13.1)*86400,
											  activation_energy_vertebrate = -0.38, activation_energy_invertebrate = -0.38,
											  T0_vertebrate = 298.15, T0_invertebrate = 298.15,
...
| Parameter                      | Meaning                                         | Default values | Reference                             |
|:-------------------------------|:------------------------------------------------|:---------------|:--------------------------------------|
| norm_constant_invertebrate     | scaling coefficient for invertebrate            | exp(9.66)/86400| Rall et al. 2012, Binzer et al. 2015  |
| norm_constant_vertebrate       | scaling coefficient for vertebrate              | exp(9.66)/86400| Rall et al. 2012, Binzer et al. 2015  |
...
Parameters can also be specified:
	- exponential_BA_handlingt(passed_temp_parameters = (norm_constant_vertebrate = exp(9.66)/86400, norm_constant_invertebrate = exp(9.66)/86400,
...
"""
function exponential_BA_handlingt(default_temp_parameters = (norm_constant_vertebrate = exp(9.66)/86400, norm_constant_invertebrate = exp(9.66)/86400,
											  activation_energy_vertebrate = 0.26, activation_energy_invertebrate = 0.26,
											  T0_vertebrate = 298.15, T0_invertebrate = 298.15,
