...
function model_parameters(A; K::Float64=1.0, Z::Float64=1.0,
        ...
        T::Float64 = 273.15,
        handlingtime::Function = NoEffectTemperature(rate_affected = :handlingtime),
        attackrate::Function = NoEffectTemperature(rate_affected = :attackrate),
        metabolicrate::Function = NoEffectTemperature(rate_affected = :metabolism),
        growthrate::Function = NoEffectTemperature(rate_affected = :growth),
